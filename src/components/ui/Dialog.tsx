...
>(({ className, ...props }, forwardedRef) => {
  return (
    <DialogPrimitives.Overlay
      ...
      className={cx(
        // base
        "fixed inset-0 z-[100000] overflow-y-auto",
        // background color
        "bg-black/70",
        // transition
    ...
    <DialogPortal>
      <DialogOverlay>
        <DialogPrimitives.Content
          ...
          className={cx(
            // base
            "fixed left-1/2 top-1/2 z-[100000] w-[95vw] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-md border p-6 shadow-lg",
            // border color
